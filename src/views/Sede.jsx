...
export default function Sede() {
  ...
  return (
    <>
      <SEOHead
        title={`Nuestra Sede - ${company.name || 'Ankaloo Construcciones'}`}
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
          ...
          <header className="mb-8 lg:mb-12">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-[10px] font-black tracking-[0.3em] text-slate-400 uppercase">Casa Central</span>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
              <div className="flex items-center gap-2 text-[#fdce27] mb-3">
                <MapPin size={18} />
                <span className="text-[10px] font-black tracking-[0.2em] uppercase text-slate-400">Ubicación</span>
              </div>
            ...
            {company.business_hours && (
              <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
                <div className="flex items-center gap-2 text-[#fdce27] mb-3">
                  <Clock size={18} />
                  <span className="text-[10px] font-black tracking-[0.2em] uppercase text-slate-400">Horarios</span>
                </div>
                <p className="text-base sm:text-lg font-black text-[#1c1c1c] leading-snug">
                  {company.business_hours}
                </p>
            ...
            <div className="bg-[#1c1c1c] rounded-2xl p-6 shadow-sm">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-[10px] font-black tracking-[0.2em] uppercase text-slate-400">Contacto</span>
              </div>
              <a
